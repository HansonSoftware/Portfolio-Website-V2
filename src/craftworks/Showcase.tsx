...
export default function Showcase() {
    return (
        <section id="showcase" className="pt-32 bg-base-100 h-screen px-8">
            <div className="grid place-content-center place-items-center">
                <h1 className="lg:text-6xl md:text-5xl sm:text-4xl text-3xl pb-2">Showcase</h1>
                <p className="text-lg">These are some examples of the work we've done.</p>
