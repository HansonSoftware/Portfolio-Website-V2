...
export default function Contact() {
    return (
        <div id="contact" className="pt-32 bg-base-100 min-h-screen px-8">
            <div className="grid place-content-center place-items-center">
                <h1 className="lg:text-6xl md:text-6xl sm:text-5xl text-5xl underline lg:pb-24 pb-8">Lets Connect</h1>
                {/* ContactForm */}
                ...
                {/* ContactForm */}
                {/* ContactFooter */}
                <div className='hero min-w-fit' style={{minHeight: "80vh"}}>
                    <div className="hero-content text-center">
                        <div className="flex flex-col gap-3">
                            <h1 className="lg:text-5xl md:text-5xl sm:text-3xl text-lg font-bold">Need help with an ambitious project?</h1>
                            <h2 className="lg:text-4xl md:text-3xl sm:text-2xl text-md font-bold">Let's build something meaningful together!</h2>
                            <h2 className="lg:text-4xl md:text-3xl sm:text-2xl text-md font-bold text-primary">Send us an email at haydenhansondev@gmail.com</h2>
                        </div>
                    </div>
                </div>
                {/* ContactFooter */}
